const runtimeData = (function () {
    ...
    return {
        ...
        // File references.
        buildURL: "bin",
        loaderURL: "bin/CC_Web_Poki.loader.js",
        dataURL: "bin/CC_Web_Poki.data.unityweb",
        frameworkURL: "bin/CC_Web_Poki.framework.js.unityweb",
        workerURL: "",
        codeURL: "bin/CC_Web_Poki.wasm.unityweb",
        symbolsURL: "",
