const runtimeData = (function () {
    ...
    return {
        ...
        productName: "YCC",
        productVersion: "1.17.11",
        sdkVersion: "3.17.15",
        productDescription: "",

        // File references.
        buildURL: "bin",
        loaderURL: "bin/CC_Web_VKontakte.loader.js",
        dataURL: "bin/CC_Web_VKontakte.data.unityweb",
        frameworkURL: "bin/CC_Web_VKontakte.framework.js.unityweb",
        workerURL: "",
        codeURL: "bin/CC_Web_VKontakte.wasm.unityweb",
        symbolsURL: "",
